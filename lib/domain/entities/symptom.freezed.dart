...
/// `id` (uuid).
 ...
 List<String> get aliases;/// `emoji_or_icon` — 아이콘 키(nullable).
...
@override
int get hashCode => Object.hash(runtimeType,id,slug,name,chosung,const DeepCollectionEquality().hash(aliases),emojiOrIcon,const DeepCollectionEquality().hash(productKeywords),orderIndex,isActive,createdAt);

@override
String toString() {
  return 'Symptom(id: $id, slug: $slug, name: $name, chosung: $chosung, aliases: $aliases, emojiOrIcon: $emojiOrIcon, productKeywords: $productKeywords, orderIndex: $orderIndex, isActive: $isActive, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id, String slug, String name, String chosung, List<String> aliases, String? emojiOrIcon, List<String> productKeywords, int orderIndex, bool isActive, DateTime createdAt
});
...
/// Create a copy of Symptom
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? slug = null,Object? name = null,Object? chosung = null,Object? aliases = null,Object? emojiOrIcon = freezed,Object? productKeywords = null,Object? orderIndex = null,Object? isActive = null,Object? createdAt = null,}) {
...
as List<String>,emojiOrIcon: freezed == emojiOrIcon ? _self.emojiOrIcon : emojiOrIcon // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String slug,  String name,  String chosung,  List<String> aliases,  String? emojiOrIcon,  List<String> productKeywords,  int orderIndex,  bool isActive,  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Symptom() when $default != null:
return $default(_that.id,_that.slug,_that.name,_that.chosung,_that.aliases,_that.emojiOrIcon,_that.productKeywords,_that.orderIndex,_that.isActive,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String slug,  String name,  String chosung,  List<String> aliases,  String? emojiOrIcon,  List<String> productKeywords,  int orderIndex,  bool isActive,  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _Symptom():
return $default(_that.id,_that.slug,_that.name,_that.chosung,_that.aliases,_that.emojiOrIcon,_that.productKeywords,_that.orderIndex,_that.isActive,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String slug,  String name,  String chosung,  List<String> aliases,  String? emojiOrIcon,  List<String> productKeywords,  int orderIndex,  bool isActive,  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _Symptom() when $default != null:
return $default(_that.id,_that.slug,_that.name,_that.chosung,_that.aliases,_that.emojiOrIcon,_that.productKeywords,_that.orderIndex,_that.isActive,_that.createdAt);case _:
  return null;
...
class _Symptom implements Symptom {
  const _Symptom({required this.id, required this.slug, required this.name, required this.chosung, final  List<String> aliases = const <String>[], this.emojiOrIcon, final  List<String> productKeywords = const <String>[], this.orderIndex = 0, this.isActive = true, required this.createdAt}): _aliases = aliases,_productKeywords = productKeywords;
...
@override
int get hashCode => Object.hash(runtimeType,id,slug,name,chosung,const DeepCollectionEquality().hash(_aliases),emojiOrIcon,const DeepCollectionEquality().hash(_productKeywords),orderIndex,isActive,createdAt);
...
/// Create a copy of Symptom
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? slug = null,Object? name = null,Object? chosung = null,Object? aliases = null,Object? emojiOrIcon = freezed,Object? productKeywords = null,Object? orderIndex = null,Object? isActive = null,Object? createdAt = null,}) {
